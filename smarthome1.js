...
//////////////////Cap nhat nhiet do/////////////////////////////
firebase.database().ref("/Phong Ngu/Temp").on("value", function(snapshot){
...
/////////////////Cap nhat do am////////////////////////////////
firebase.database().ref("/Phong Ngu/Humi").on("value", function(snapshot){
...
/////////////////Cap nhat gas////////////////////////////////
firebase.database().ref("/Phong Ngu/Gas").on("value", function(snapshot){
...
/////////////////Cap nhat anh sang////////////////////////////////
firebase.database().ref("/Phong Ngu/LightSensor").on("value", function(snapshot){
...
var bed;
var fan;
database.ref("/Phong Ngu").on("value", function(snap){
bath = snap.val().bath;
...
var firebaseRef = firebase.database().ref().child("/Phong Ngu/bath");
if(bath == "1"){
firebaseRef.set("0");
bath = "0";
} else {
...
var firebaseRef = firebase.database().ref().child("/Phong Ngu/phone");
if(phone == "1"){
firebaseRef.set("0");
phone = "0";
} else {
...
var firebaseRef = firebase.database().ref().child("/Phong Ngu/tv");
if(tv == "1"){
firebaseRef.set("0");
tv = "0";
} else {
...
var firebaseRef = firebase.database().ref().child("/Phong Ngu/bed");
if(bed == "1"){
firebaseRef.set("0");
bed = "0";
} else {
...
$(".toggle-btn4").click(function(){
  var firebaseRef = firebase.database().ref().child("/Phong Ngu/fan");
  if(fan == "1"){
  firebaseRef.set("0");
  fan = "0";
  } else {
...
firebase.database().ref("/Phong Ngu").update({
Vol: value
});
slide_value.textContent = value;
slide_value.style.left = (value/2) + "%";
});
firebase.database().ref('/Phong Ngu/Vol').on('value', (snapshot) => {
